...
bot = telebot.TeleBot('7460010171:AAGGvV3wihIcgyCKm0yP_FLvi8gneyCaSYA')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = """❌ You Are Not Authorized To Use This Command ❌.
                      🛒 Please Buy From OWNER/RESSELLER"""
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to The Bot, {user_name}
                    24/7 ACTIVE 🚀💥. 
                     TYPE /bgmi TO ATTACK'''
    bot.reply_to(message, response)
